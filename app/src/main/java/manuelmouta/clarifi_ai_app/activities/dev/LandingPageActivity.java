...
import manuelmouta.clarifi_ai_app.activities.release.ReleaseLandingPageActivity;
...
public class LandingPageActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!BuildConfig.DEV_VERSION) {
            Intent intent = new Intent(LandingPageActivity.this,ReleaseLandingPageActivity.class);
